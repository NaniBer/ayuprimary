function VideoGallery() {
  ...
  return (
    <div className="py-24 bg-gradient-to-br from-gray-900 via-blue-900 to-gray-900 relative overflow-hidden">
      ...
      <div className="absolute bottom-0 right-0 w-96 h-96 bg-cyan-500 rounded-full filter blur-3xl opacity-20"></div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative">
        <div className="text-center mb-16">
          ...
          <div className="w-24 h-1.5 bg-gradient-to-r from-blue-400 to-cyan-300 mx-auto rounded-full mb-6"></div>
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6">
          {videos.map((video, index) => (
            <div key={index} className="group relative">
              <div className="absolute inset-0 bg-gradient-to-br from-blue-500 to-cyan-500 rounded-2xl transform group-hover:scale-105 transition-all opacity-0 group-hover:opacity-100 blur-xl"></div>
              <div className="relative bg-white/10 backdrop-blur-md rounded-2xl overflow-hidden border border-white/20 hover:border-white/40 transition-all">
                ...
                <div className="p-5">
                  <div className={`inline-block bg-gradient-to-r ${video.gradient} text-white text-xs font-bold px-3 py-1 rounded-full mb-3`}>
                    {video.title.split(' ')[0]}
                  </div>
